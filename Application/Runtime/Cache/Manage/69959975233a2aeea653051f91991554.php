                    ...
                    <div class='xzen xzen1'>
                        ...
                        <ul style='padding-top:40px; padding-bottom:50px;'>
                            <form method="post" enctype="multipart/form-data">
                                <li>
                                    <span>所属菜单：</span>
                                    <input type='' name='' value="<?php echo ($mee["mname"]); ?>" readonly>
                                </li>
                                <li>
                                    <span>信息标题</span>
                                ...
                                <li>
                                    <span>简介</span>
                                    <input type='' name="info" value="<?php echo ($info["info"]); ?>">
                                </li>
                                <li>
                                    <span>展示图片：</span><br/>
                                    <img src="/Uploads/<?php echo ($info["picture"]); ?>" style="margin-left: 87px;width: 300px;" /><br/><br/>
                                ...
                                <li class='xh-an'>
                                    ...
                                    <button type="button" onclick="location.href='javascript:history.go(-1);';" class="czhi">取消</button>
                                </li>
                            </form>
                        </ul>
                    </div>
