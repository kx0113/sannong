                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="example-1" class="table table-striped dt-responsive display table1">
                                    ...
                                    <tbody>
                                    <?php if(is_array($emergency_list )): $i = 0; $__LIST__ = $emergency_list ;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr data-in='0'>
                                            <!--<td><span class='dx-zi'></span></td>-->
                                            <td><?php echo ($vo["id"]); ?></td>
                                            <td><a href="<?php echo U('Manage/Ygl/emergency_list',array('pid'=>$vo[id]));?>"><?php echo ($vo["name"]); ?></a> </td>
                                            ...
                                            <td>
                                            	<?php if($i <= 1): ?><a onclick="return confirm('确定删除此信息？')" href="/Manage/Ygl/emergency_del/pid/<?php echo ($vo["id"]); ?>" class='cz'><i class='fa fa-trash' data-nub='0'></i></a>
                                                <a href="<?php echo U('Manage/Ygl/emergency_edit',array(id=>$vo[id]));?>" class='cz'><i class='fa fa-pencil'></i></a><?php endif; ?>
                                            </td>
                                        </tr>
