            ...
            <div class="col-lg-12">
                <section class="box ">
                    <header class="panel_header">
                        <h2 class="title pull-left">广告图</h2>
                        <div class="actions panel_actions pull-right">
                            <div class='pl cle' style='margin-bottom:10px;'>
                                <!--<a href="" class="da da1"><i class="fa fa-upload"></i>导入</a>-->
                                <a href="<?php echo U('Manage/Ygl/ygl_adver_add');?>" class="da da2"><i class="fa fa-plus"></i>新增</a>
                                <!--<a href="javascript:;" class="da da3"><i class="fa fa-trash"></i>删除</a>-->
                                <label>
                                    <!--<form>-->
                                    <!--<select type="search" name="s_status">-->
                                    	<!--<option value="" <?php if($st==0): ?>selected<?php endif; ?> >请选择</option>-->
                                    	<!--<option value="1" <?php if($st==1): ?>selected<?php endif; ?> >已处理</option>-->
                                    	<!--<option value="2" <?php if($st==2): ?>selected<?php endif; ?> >处理中</option>-->
                                    	<!--<option value="3" <?php if($st==3): ?>selected<?php endif; ?> >待处理</option>-->
                                    <!--</select>-->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="example-1" class="table table-striped dt-responsive display table1">
                                    ...
                                    <tbody>
                                    <?php if(is_array($banner_list)): $i = 0; $__LIST__ = $banner_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr data-in='0'>
                                            <!--<td><span class='dx-zi'></span></td>-->
                                            <td><?php echo ($vo["id"]); ?></td>
                                            <td><?php if($vo["type"] == 1): ?>易管理 <?php elseif($vo["type"] == 2): ?>易家家<?php endif; ?></td>
                                            <td>  <img src="/Uploads/<?php echo ($vo["picture"]); ?>" style="margin-left: 87px;width: 80px;" /><br/><br/></td>
                                            <td>
                                                <a onclick="return confirm('确定删除此信息？')" href="/Manage/Ygl/ygl_adver_del/id/<?php echo ($vo["id"]); ?>" class='cz'><i class='fa fa-trash' data-nub='0'></i></a>
                                                <a href="<?php echo U('/Manage/Ygl/ygl_adver_edit',array(id=>$vo[id]));?>" class='cz'><i class='fa fa-pencil'></i></a>
                                            </td>
