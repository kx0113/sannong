        ...
        <div class="col-lg-12">
            <section class="box ">
                    <header class="panel_header">
                        <h2 class="title pull-left">信息列表</h2>
                        <div class="actions panel_actions pull-right">
                             <div class='pl cle' style='margin-bottom:10px;'>
                            <!--<a href="" class="da da1"><i class="fa fa-upload"></i>导入</a>-->
                                 <?php if($dept_id > 0): ?><a href="<?php echo U('addInfo');?>" class="da da2"><i class="fa fa-plus"></i>新增</a><?php endif; ?>
                            <!--<a href="javascript:;" class="da da3"><i class="fa fa-trash"></i>删除</a>-->
                                 <label>
                                 <form>
                                 	<?php if($dept_id == 0): ?><select name="dept_id">
                                 			<?php if(is_array($dept)): $i = 0; $__LIST__ = $dept;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["did"]); ?>" <?php if($dp == $vo['did']): ?>selected<?php endif; ?>><?php echo ($vo["dname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                 		</select><?php endif; ?>
                                     <input type="search" name="keyword" placeholder="请输入标题关键字">
                            ...
                            <div class="col-xs-12">
                                <table id="example-1" class="table table-striped dt-responsive display table1">
                                    ...
                                    <?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr data-in='0'>
                                            ...
                                            <td>
                                                <?php if($dept_id > 0): ?><a onclick="return confirm('确定删除此信息？')" href="/Manage/Dept/delInfo/aid/<?php echo ($vo["aid"]); ?>" class='cz'><i class='fa fa-trash' data-nub='0'></i></a><?php endif; ?>
                                                    <a href="<?php echo U('Manage/Dept/editInfo',array(aid=>$vo[aid]));?>" class='cz'><i class='fa fa-pencil'></i></a>
                                            </td>
