                ...
                <section class="box ">
                    <header class="panel_header">
                        <h2 class="title pull-left">应急管理-
                            <a style="color: #000;" href="<?php echo U('emergency_index');?>" class="da da2">应急警报</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                            <a href="<?php echo U('emergency_message_index');?>" class="da da2">预警通知</a>
                        </h2>
                        <div class="actions panel_actions pull-right">
                            <div class='pl cle' style='margin-bottom:10px;'>
                                <!--<a href="" class="da da1"><i class="fa fa-upload"></i>导入</a>-->
                                <a href="<?php echo U('emergency_message_add');?>" class="da da2"><i class="fa fa-plus"></i>新增</a>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="example-1" class="table table-striped dt-responsive display table1">
                                    ...
                                    <tbody>
                                    <?php if(is_array($big_data)): $i = 0; $__LIST__ = $big_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr data-in='0'>
                                            <!--<td><span class='dx-zi'></span></td>-->
                                            <td><?php echo ($vo["id"]); ?></td>
                                            <td><?php echo ($vo["title"]); ?></td>
                                            <td><?php echo ($vo["afrom"]); ?></td>
                                            <td><?php echo ($vo["addtime"]); ?></td>

                                            <td>
                                                <a onclick="return confirm('确定删除此信息？')" href="/Manage/Ygl/emergency_message_del/pid/<?php echo ($vo["id"]); ?>" class='cz'><i class='fa fa-trash' data-nub='0'></i></a>
                                                <a href="<?php echo U('Manage/Ygl/emergency_message_edit',array(id=>$vo[id]));?>" class='cz'><i class='fa fa-pencil'></i></a>
                                            </td>
