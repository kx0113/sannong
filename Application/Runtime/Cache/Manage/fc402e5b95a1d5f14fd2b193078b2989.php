        ...
        <div class="col-lg-12">
            <section class="box ">
                    <header class="panel_header">
                        <h2 class="title pull-left">公告列表</h2>
                        <div class="actions panel_actions pull-right">
                             <div class='pl cle' style='margin-bottom:10px;'>
                            <!--<a href="" class="da da1"><i class="fa fa-upload"></i>导入</a>-->
                            <a href="/Manage/Yjj/yjj_notice_add/" class="da da2"><i class="fa fa-plus"></i>新增</a>
                            ...
                            <div class="col-xs-12">
                                <table id="example-1" class="table table-striped dt-responsive display table1">
                                    ...
                                    <?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr data-in='0'>
                                            ...
                                            <td>
                                                <?php if($vo['type'] == 1): ?>易管理<?php endif; ?>
                                                <?php if($vo['type'] == 2): ?>易家家<?php endif; ?>
                                            </td>
                                            <td><?php echo ($vo["bm"]); ?></td>
                                            <td><?php echo ($vo["title"]); ?></td>

                                            <td>
                                                <a onclick="return confirm('确定删除此信息？')" href="/Manage/Yjj/yjj_notice_del/id/<?php echo ($vo["id"]); ?>" class='cz'><i class='fa fa-trash' data-nub='0'></i></a>
                                                <a href="/Manage/Yjj/yjj_notice_edit/?id=<?php echo ($vo["id"]); ?>" class='cz'><i class='fa fa-pencil'></i></a>
                                            </td>
