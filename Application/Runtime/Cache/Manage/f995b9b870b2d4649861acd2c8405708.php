            ...
            <section class="box ">
                    <header class="panel_header">
                        ...
                        <div class="actions panel_actions pull-right">
                            ...
                            <a href="<?php echo U('adminAdd');?>" class="da da2"><i class="fa fa-plus"></i>新增</a>
                            ...
                            <div class="col-xs-12">
                                <table id="example-1" class="table table-striped dt-responsive display table1">
                                    ...
                                    <?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr data-in='0'>
                                            ...
                                            <td>
                                                <a onclick="return confirm('确定删除此信息？')" href="/Manage/Index/adminDel/aid/<?php echo ($vo["aid"]); ?>" class='cz'><i class='fa fa-trash' data-nub='0'></i></a>
                                                <a href="<?php echo U('Manage/Index/adminEdit',array(aid=>$vo[aid]));?>" class='cz'><i class='fa fa-pencil'></i></a>
                                            </td>
