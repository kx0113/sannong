                    ...
                    <header class="panel_header">
                        ...
                        <div class="actions panel_actions pull-right">
                            <div class='pl cle' style='margin-bottom:10px;'>
                                ...
                                <a href="<?php echo U('/Manage/Yjj/yjj_adver_add');?>" class="da da2"><i class="fa fa-plus"></i>新增</a>
                            ...
                            <div class="col-xs-12">
                                <table id="example-1" class="table table-striped dt-responsive display table1">
                                    ...
                                    <?php if(is_array($banner_list)): $i = 0; $__LIST__ = $banner_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr data-in='0'>
                                            ...
                                            <td>
                                                <a onclick="return confirm('确定删除此信息？')" href="/Manage/Yjj/yjj_adver_del/id/<?php echo ($vo["id"]); ?>" class='cz'><i class='fa fa-trash' data-nub='0'></i></a>
                                                <a href="<?php echo U('/Manage/Yjj/yjj_adver_edit',array(id=>$vo[id]));?>" class='cz'><i class='fa fa-pencil'></i></a>
                                            </td>
