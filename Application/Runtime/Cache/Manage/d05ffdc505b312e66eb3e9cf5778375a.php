        ...
        <div class="col-lg-12">
            <section class="box ">
                    <header class="panel_header">
                        <h2 class="title pull-left">部门聊天列表</h2>
                        <div class="actions panel_actions pull-right">
                             <div class='pl cle' style='margin-bottom:10px;'>
                            <!--<a href="" class="da da1"><i class="fa fa-upload"></i>导入</a>-->
                           <!--  <a href="/Manage/Ygl/wzcAdd" class="da da2"><i class="fa fa-plus"></i>新增</a> -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="example-1" class="table table-striped dt-responsive display table1">
                                    ...
                                    <!--</tfoot>-->
                                    <tbody>
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr data-in='0'>
                                            <!--<td><span class='dx-zi'></span></td>-->
                                            <td>易管理</td>
                                            <td><?php echo ($vo["dname"]); ?></td>
                                            <td><?php echo ($vo["ygl_server"]); ?></td>
                                            <td><?php echo ($vo["real_name"]); ?></td>
                                            <td><?php echo ($vo["mobile"]); ?></td>
                                            <td>
                                               <!--  <a onclick="return confirm('确定删除此信息？')" href="/Manage/Ygl/wzcDel/id/<?php echo ($vo["id"]); ?>" class='cz'><i class='fa fa-trash' data-nub='0'></i></a> -->
                                                <a href="/Manage/Ygl/ygl_bmltEdit/?did=<?php echo ($vo["did"]); ?>" class='cz'><i class='fa fa-pencil'></i></a>
                                            </td>
