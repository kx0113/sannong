            ...
            <div class="col-lg-12">
                <section class="box ">
                    <header class="panel_header">
                        <h2 class="title pull-left">应急管理</h2>
                            ...
                            <div class='pl cle' style='margin-bottom:10px;'>
                                ...
                                <label>
                                    ...
                                    <select type="search" name="s_status">
                                        ...
                                        <input type="search" name="keyword" placeholder="请输入关键 字" >
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="example-1" class="table table-striped dt-responsive display table1">
                                    ...
                                    <tr data-in='0'>
                                        <td>1</td>
                                        <td><a href="<?php echo U('Manage/Ygl/emergency_index');?>">应急警报</a></td>
                                    </tr>
                                    <tr data-in='0'>
                                        <td>2</td>
                                        <td><a href="<?php echo U('Manage/Ygl/emergency_message_index');?>">预警通知</a></td>
                                    </tr>
                                    <!--<?php if(is_array($emergency_list )): $i = 0; $__LIST__ = $emergency_list ;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
                                        <!--<tr data-in='0'>-->
                                            <!--&lt;!&ndash;<td><span class='dx-zi'></span></td>&ndash;&gt;-->
                                            <!--<td><?php echo ($vo["id"]); ?></td>-->
                                            <!--<td><a href="<?php echo U('Manage/Ygl/emergency_index',array('gid'=>$vo[id]));?>"><?php echo ($vo["name"]); ?></a> </td>-->
                                            ...
                                            <!--<td>-->
                                                <!--<a onclick="return confirm('确定删除此信息？')" href="/Manage/Ygl/geography_del/pid/<?php echo ($vo["id"]); ?>" class='cz'><i class='fa fa-trash' data-nub='0'></i></a>-->
                                                <!--<a href="<?php echo U('Manage/Ygl/emergency_edit',array(id=>$vo[id]));?>" class='cz'><i class='fa fa-pencil'></i></a>-->
                                            <!--</td>-->
                                        <!--</tr>-->
